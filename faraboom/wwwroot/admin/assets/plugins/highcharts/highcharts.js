...
(function (T, K) {
    ...
    (function (a) {
        ...
        a.Fx.prototype = {
            ...
            initPath: function (m, h, f) {
                ...
                function q(a, b) {
                    for (var c = (k - a.length) / z; 0 < c && c--;) d = a.slice().splice(a.length / p - z, z * p), d[0] = b[k - z - c * z], l && (d[z - 6] = d[z - 2], d[z - 5] = d[z - 1]), [].splice.apply(a, [a.length / p, 0].concat(d)), u && c--
                }
                h = h || "";
                var w, e = m.startX,
                    c = m.endX,
        ...
        a.pick = function () {
            var a = arguments,
                h, f, r = a.length;
            for (h = 0; h < r; h++)
                if (f = a[h], void 0 !== f && null !== f) return f
        };
        a.css = function (m, h) {
        ...
        a.numberFormat = function (m, h, f, r) {
            ...
            var y = a.defaultOptions.lang,
                ...
                w, e, c = m.toString().split("e"); - 1 === h ? h = Math.min(q, 20) : a.isNumber(h) ? h && c[1] && 0 > c[1] && (w = h + +c[1], 0 <= w ? (c[0] = (+c[0]).toExponential(w).split("e")[0], h = w) : (c[0] = c[0].split(".")[0] || 0, m = 20 > h ? (c[0] * Math.pow(10, c[1])).toFixed(h) : 0, c[1] = 0)) : h = 2;
            e = (Math.abs(c[1] ?
    ...
    (function (a) {
        ...
        a.Color.prototype = {
            ...
            init: function (f) {
                var h,
                    y, q, w;
                if ((this.input = f = this.names[f && f.toLowerCase ? f.toLowerCase() : ""] || f) && f.stops) this.stops = E(f.stops, function (e) {
            ...
            brighten: function (a) {
                ...
                if (this.stops) C(this.stops, function (f) {
                    ...
                    for (f = 0; 3 > f; f++) y[f] += h(255 * a), 0 > y[f] && (y[f] = 0), 255 < y[f] && (y[f] = 255);
                return this
            },
    ...
    (function (a) {
        ...
        k(C.prototype, {
                ...
                if (!A) {
                    if (v.namespaceURI ===
                        ...
                        try {
                            ...
                            }) && l("none"), A = v.getBBox ? k({}, v.getBBox()) : {
                                width: v.offsetWidth,
            ...
            shadow: function (a, g, b) {
                ...
                if (!a) this.destroyShadows();
                    ...
                    for (d = 1; d <= n; d++) v = c.cloneNode(0), k = 2 * n + 1 - 2 * d, h(v, {
                        isShadow: "true",
        ...
        k(D.prototype, {
            ...
            getStyle: function (a) {
                return this.style = k({
                    fontFamily: '"iransans", "Lucida Grande", "Lucida Sans Unicode", Arial, Helvetica, sans-serif',
                    fontSize: "12px"
                }, a)
            },
            setStyle: function (a) {
                                ...
                                if (" " !== g) {
                                    ...
                                    if (t) {
                                        ...
                                        var x = [],
                                            z, O = I(u),
                                            w = a.rotation;
                                        for (f && (e = v.applyEllipsis(a, u, g, t)); !f && G && (n.length || x.length);) a.rotation = 0, z = v.getSpanWidth(a, u), g = z > t, void 0 === e && (e = g), g && 1 !== n.length ? (u.removeChild(u.firstChild), x.unshift(n.pop())) : (n = x, x = [], n.length && !P && (u = l.createElementNS(J, "tspan"), h(u, {
                                                dy: O,
                                                x: B
    ...
    (function (a) {
        ...
        a.defaultOptions = {
            ...
            lang: {
                loading: "Loading...",
                months: "خرداد تیر مرداد شهریور مهر آبان آذر دی بهمن اسفند فروردین اردیبهشت".split(" "),
                shortMonths: "خرداد تیر مرداد شهریور مهر آبان آذر دی بهمن اسفند فروردین اردیبهشت".split(" "),
                weekdays: "شنبه یکشنبه دوشنبه سه شنبه چهارشنبه پنج شنبه جمعه".split(" "),
                decimalPoint: ".",
    ...
    (function (a) {
        ...
        a.Tick.prototype = {
            ...
            renderGridLine: function (a, f, e) {
                ...
                if (!a && h && (a = c.getPlotLinePath(d + u, h.strokeWidth() * e, a, !0))) h[this.isNew ?
                    "attr" : "animate"]({
                    d: a,
                    opacity: f
                })
        ...
        a.extend(F.prototype, {
            ...
            defaultLabelFormatter: function () {
                ...
                if (u) l = z(u, this, d);
                    ...
                    for (; p-- && void 0 === l;) d = Math.pow(n, p + 1), g >= d && 0 === 10 * b % d && null !== e[p] && 0 !== b && (l = a.numberFormat(b / d, -1) + e[p]);
                    ...
                    e(a.series,
                        function (g) {
                            if (g.visible || !b.options.chart.ignoreHiddenSeries) {
                                ...
                                if (a.isXAxis) v = g.xData, v.length && (g = m(v), k = E(v), p(g) || g instanceof Date || (v = d(v, p), g = m(v), k = E(v)), v.length && (a.dataMin = Math.min(I(a.dataMin, v[0], g), g), a.dataMax = Math.max(I(a.dataMax, v[0], k), k)));
            ...
            getMinorTickPositions: function () {
                var a = this,
                    ...
                    l = n - p;
                if (l && l / c < a.len / 3)
                    if (a.isLog) e(this.paddedTicks, function (g, b, d) {
            ...
            adjustForMinRange: function () {
                ...
                this.isXAxis && void 0 === this.minRange && !this.isLog && (y(a.min) || y(a.max) ? this.minRange = null : (e(this.series, function (a) {
                    ...
                    for (p = B = a.xIncrement ? 1 : u.length - 1; 0 < p; p--)
                        if (l = u[p] - u[p - 1], void 0 === n || l < n) n = l
            ...
            setAxisTranslation: function (a) {
                var b = this,
                    ...
                    f = b.transA,
                    B = b.isXAxis;
                if (B || u || d) c = b.getClosest(), p ? (k = p.minPointOffset, n = p.pointRangePadding) : e(b.series, function (a) {
            ...
            zoom: function (a, b) {
                ...
                if (a !== this.min || b !== this.max) this.allowZoomOutside || (y(g) && (a < k && (a = k), a > c && (a = c)), y(d) && (b < k && (b = k), b > c && (b = c))), this.displayBtn = void 0 !== a || void 0 !== b, this.setExtremes(a, b, !1, void 0, {
                    trigger: "zoom"
                });
                return !0
            },
            ...
            renderUnsquish: function () {
                ...
                if (this.autoRotation) x > u && x > f.h ? B.rotation = this.labelRotation : this.labelRotation = 0;
                    ...
                    for (G = "clip", u = d.length; !p && u--;)
                        if (z = d[u], z = c[z].label) z.styles && "ellipsis" === z.styles.textOverflow ? z.css({
                            textOverflow: "clip"
                ...
                if (this.labelAlign =
                    k.align || this.autoLabelAlign(this.labelRotation)) B.align = this.labelAlign;
                e(d, function (a) {
                    var b = (a = c[a]) && a.label,
                        g = n.width,
                        d = {};
    ...
    (function (a) {
        ...
        C.prototype.getLogTickPositions = function (a, r, y, q) {
            ...
            if (.5 <= a) a = Math.round(a), c = this.getLinearTickPositions(a, r, y);
            else if (.08 <= a)
            ...
            else r = this.lin2log(r), y = this.lin2log(y), a = q ? this.getMinorTickInterval() : f.tickInterval, a = h("auto" === a ? null : a, this._minorAutoInterval, f.tickPixelInterval / (q ? 5 : 1) * (y - r) / ((q ? e / this.tickPositions.length :
    ...
    (function (a, C) {
        ...
        a.extend(C.prototype, {
            getPlotBandPath: function (a, e) {
                ...
                if (l && c)
                    for (a && (b = l.toString() === c.toString(), d = 0), a = 0; a < l.length; a += 6) k && c[a + 1] === l[a + 1] ? (c[a + 1] += d, c[a + 4] += d) : k || c[a + 2] !== l[a + 2] || (c[a +
            ...
            removePlotBandOrLine: function (a) {
                for (var e = this.plotLinesAndBands, c = this.options,
                        l = this.userOptions, h = e.length; h--;) e[h].id === a && e[h].destroy();
        ...
        a.Pointer.prototype = {
            ...
            findNearestKDPoint: function (a, d, k) {
                ...
                r(a, function (a) {
                    ...
                    a = a.searchPoint(k, e);
                    if ((e = c(a,
                            !0)) && !(e = !c(b, !0))) var e = b.distX - a.distX,
                        f = b.dist - a.dist,
            ...
            runPointActions: function (b, d) {
                ...
                if (f && (f !== c.hoverPoint || k && k.isHidden)) {
                    ...
                    c.hoverPoint = f;
                    k && k.refresh(e ? u : f, b)
                } else d && k && !k.isHidden && (f = k.getAnchor([{}], b),
                    k.updatePosition({
                        plotX: f[0],
                        plotY: f[1]
                    }));
            ...
            reset: function (a, d) {
                ...
                if (a) l && u && (l.refresh(u), l.shared && f ? r(f, function (a) {
            ...
            drop: function (a) {
                ...
                if (this.selectionMarker) {
                    var k = {
                        ...
                        B;
                    if (this.hasDragged || c) r(d.axes, function (d) {
    ...
    (function (a) {
        ...
        z(Q.prototype, {
            ...
            getArgs: function () {
                ...
                if (H(a[0]) || a[0].nodeName) this.renderTo =
                    a.shift();
                this.init(a[0], a[1])
            },
            init: function (b, c) {
            ...
            redraw: function (b) {
                ...
                for (b = g.length; b--;)
                    ...
                    for (b = g.length; b--;) v = g[b], v.options.stacking && (v.isDirty = !0);
                l(g, function (a) {
            ...
            reflow: function (b) {
                ...
                if (!n && !d.isPrinting && k && g && (e === P || e === h)) {
                    if (k !== d.containerWidth || g !== d.containerHeight) a.clearTimeout(d.reflowTimeout), d.reflowTimeout = v(function () {
            ...
            drawChartBox: function () {
                ...
                if (f || e["stroke-width"]) h.stroke = a.borderColor, h["stroke-width"] =
                    f;
    ...
    (function (a) {
        ...
        D.prototype.applyFixed = function () {
            ...
            r && (this.fixedDiv = a.createElement("div", {
                ...
                ".highcharts-yaxis", this.inverted ? ".highcharts-xaxis-labels" : ".highcharts-yaxis-labels", ".highcharts-contextbutton", ".highcharts-credits", ".highcharts-legend", ".highcharts-subtitle", ".highcharts-title", ".highcharts-legend-checkbox"
            ], function (f) {
        ...
        a.Point.prototype = {
            ...
            optionsToObject: function (e) {
                ...
                if (y(e) || null === e) c[k[0]] = e;
                    ...
                    for (!h &&
                        e.length > d && (f = typeof e[0], "string" === f ? c.name = e[0] : "number" === f && (c.x = e[0]), b++); u < d;) h && void 0 === e[b] || (0 < k[u].indexOf(".") ? a.Point.prototype.setNestedProperty(c, e[b], k[u]) : c[k[u]] = e[b]), b++, u++;
    ...
    (function (a) {
        ...
        a.Series = a.seriesType("line", null, {
            ...
            setData: function (b, c, e, f) {
                ...
                if (!y) {
                    ...
                    if (u && l > u) {
                        ...
                        if (k(t))
                            for (e = 0; e < l; e++) m[e] = this.autoIncrement(), r[e] = b[e];
                        else if (z(t))
                            if (w)
                                for (e = 0; e < l; e++) t = b[e], m[e] = t[0], r[e] = t.slice(1, w + 1);
                            else
                                for (e = 0; e < l; e++) t = b[e], m[e] = t[0], r[e] = t[1];
                        else a.error(12)
                    } else
                        for (e =
                            0; e < l; e++) void 0 !== b[e] && (t = {
                            series: n
            ...
            processData: function (b) {
                ...
                for (h = c.length || 1; --h;) e = x ? l(c[h]) - l(c[h - 1]) : c[h] - c[h - 1], 0 < e && (void 0 ===
            ...
            generatePoints: function () {
                ...
                for (m = 0; m < k; m++) l = h + m, p ? (x = (new f).init(this, [e[m]].concat(t(g[m]))), x.dataGroup = this.groupMap[m]) : (x = c[l]) || void 0 === b[l] || (c[l] = x = (new f).init(this, b[l], e[m])), x && (x.index = l, u[m] = x);
                this.options.keys = a;
                if (c && (k !== (d = c.length) || p))
                    for (m = 0; m < d; m++) m !== h || p || (m += k), c[m] && (c[m].destroyElements(), c[m].plotX = void 0);
                this.data = c;
                this.points = u
            },
            getExtremes: function (a) {
                ...
                for (x = 0; x < d; x++)
                    if (l = c[x], t = a[x], h = (k(t, !0) || z(t)) && (!b.positiveValuesOnly || t.length || 0 < t), l = this.getExtremesFromAll || this.options.getExtremesFromAll || this.cropped || (c[x + p] || l) >= f && (c[x - p] || l) <= n, h && l)
                        if (h = t.length)
                            for (; h--;) "number" === typeof t[h] && (e[g++] = t[h]);
                        else e[g++] = t;
                this.dataMin = m(e);
                this.dataMax = E(e)
            },
            ...
            drawPoints: function () {
                var a = this.points,
                    ...
                    x, m = p(f.enabled, this.xAxis.isRadial ? !0 : null, this.closestPointRangePx >= f.enabledThreshold * f.radius);
                if (!1 !== f.enabled || this._hasPointMarkers)
                    for (c = 0; c < a.length; c++) d = a[c], g = d.graphic, k = d.marker || {}, h = !!d.marker, e = m && void 0 === k.enabled || k.enabled, l = d.isInside, e && !d.isNull ? (e =
        ...
        q(p.prototype, {
            ...
            update: function (c, d) {
                var f = this,
                    ...
                    g = H[p].prototype,
                    x, m = ["group", "markerGroup", "dataLabelsGroup"],
        ...
        f("area", "line", {
            ...
            getStackPoints: function (f) {
                var h = [],
                    ...
                    k = e.series,
                    d = k.length,
                    b, u = m(e.options.reversedStacks, !0) ? 1 : -1,
                    p;
                f = f || this.points;
                if (this.options.stacking) {
                    ...
                    D(q, function (a, f) {
                        var k = 0,
                            t, m;
                        if (l[a] && !l[a].isNull) h.push(l[a]), D([-1, 1], function (e) {
                            var k =
                                1 === e ? "rightNull" : "leftNull",
                                h = 0,
                                n = c[q[f + e]];
                            if (n)
                                for (p = z; 0 <= p && p < d;) t = n.points[p], t || (p === z ? l[a][k] = !0 : b[p] && (m = c[a].points[p]) && (h -= m[1] - m[0])), p += u;
            ...
            getGraphPath: function (a) {
                ...
                for (c = 0; c < a.length; c++)
                    if (l = a[c].isNull, b = m(a[c].rectPlotX,
                            a[c].plotX), t = m(a[c].yBottom, H), !l || q) q || L(c, c - 1, "left"), l && !r && q || (k.push(a[c]), z.push({
                        x: c,
                        plotX: b,
                        plotY: t
                    })), q || L(c, c + 1, "right");
        ...
        c("pie", "line", {
            ...
            translate: function (a) {
                ...
                var c = 0,
                    ...
                    b = d.slicedOffset,
                    e = b + (d.borderWidth || 0),
                    h, l, t, m = f(d.startAngle, d.endAngle),
                    x = this.startAngleRad = m.start,
                    m = (this.endAngleRad = m.end) - x,
                    r = this.points,
                    n, w = d.dataLabels.distance,
    ...
    (function (a) {
        ...
        a.distribute = function (c, b, f) {
            ...
            z(c, function (c) {
                ...
                if (z(c.targets, function () {
                        l[e].pos = c.pos + d;
                        if (Math.abs(l[e].pos - l[e].target) > f) return m(l.slice(0, e + 1), function (a) {
                            delete a.pos
        ...
        c.prototype.drawDataLabels = function () {
            ...
            var b = this,
                ...
                D = e.renderer;
            if (h.enabled || b._hasPointLabels) b.dlProcessOptions && b.dlProcessOptions(h), z = b.plotGroup("dataLabelsGroup", "data-labels", B && !r ? "hidden" : "visible", h.zIndex || 6), B && (z.attr({
                opacity: +r
        ...
        c.prototype.alignDataLabel = function (a, b, c, e, f) {
            ...
            if (u && (p = c.style.fontSize,
                    p = d.renderer.fontMetrics(p, b).b, e = h({
                        ...
                        null, e), l = b.alignAttr), g && 0 <= e.height ? a.isLabelJustified = this.justifyDataLabel(b, c, l, n, e, f) : w(c.crop, !0) && (u = d.isInsidePlot(l.x, l.y) && d.isInsidePlot(l.x + n.width, l.y + n.height)), c.shape && !q)) b[f ? "attr" : "animate"]({
        ...
        l.pie && (l.pie.prototype.drawDataLabels = function () {
            ...
            d.visible && (k.enabled || d._hasPointLabels) && (m(b, function (a) {
                ...
                if ((g = a.dataLabel) && g._pos && a.visible && 0 < a.labelDistance) {
                    ...
                    if (b = !y) a.connector = y = f.renderer.path().addClass("highcharts-data-label-connector  highcharts-color-" +
    ...
    (function (a) {
        ...
        C.prototype.hideOverlappingLabels = function (a) {
            ...
            for (q = 0; q < f; q++)
                if (m = a[q]) m.oldOpacity = m.opacity, m.newOpacity = 1, m.absoluteBox = w(m);
            a.sort(function (a, c) {
            ...
            for (q = 0; q < f; q++)
                for (l = (w = a[q]) && w.absoluteBox, m = q + 1; m < f; ++m)
                    if (c = (e = a[m]) && e.absoluteBox, l && c && w !== e && 0 !== w.newOpacity && 0 !== e.newOpacity && (c = z(l.x, l.y, l.width,
                            l.height, c.x, c.y, c.width, c.height)))(w.labelrank < e.labelrank ? w : e).newOpacity = 0;
            D(a, function (a) {
                var c, b;
        ...
        y(d.prototype, {
            ...
            setState: function (a, b) {
                ...
                if (!(a === this.state && !b || this.selected && "select" !== a || !1 ===
                    ...
                    if (this.graphic) this.state && this.graphic.removeClass("highcharts-point-" + this.state), a && this.graphic.addClass("highcharts-point-" + a), this.graphic.animate(e.pointAttribs(this, a), k(u.options.chart.animation, h.animation)), z && this.graphic.animate(z, k(u.options.chart.animation, p.animation, l.animation)), t && t.hide();
                    else {
                        if (a && p) {
                            l = r.symbol || e.symbol;
            ...
            function q(e, c, f, w) {
                ...
                a.objectEach(e, function (a, b) {
                    if (!w && -1 < E(b, ["series", "xAxis", "yAxis"]))
                        for (a = r(a), f[b] = [], k = 0; k < a.length; k++) c[b][k] && (f[b][k] = {}, q(a[k], c[b][k], f[b][k], w + 1));
